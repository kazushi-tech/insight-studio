...
const faqs = [
  ...
  },
  {
    ...
    a: 'Proプランの主要機能をお試しいただけます。競合LP比較、クリエイティブ診断、広告パフォーマンス考察、AI Explorerなどを、トライアル条件内で確認できます。',
  },
  {
    q: 'データのセキュリティはどのように担保されていますか？',
    a: '通信保護、権限管理、接続先ごとの認証情報分離を前提に設計しています。監査要件や個別のセキュリティ確認が必要な場合は、Enterpriseプランで運用条件を確認します。',
  },
  {
  ...
  return (
    <>
      ...
      <LpCta
        variant="dark"
        heading={'まずは14日間、無料で\n主要機能をお試しください。'}
        body="Proプランの主要機能を14日間無料で確認できます。クレジットカード登録不要。いつでもキャンセル可能です。"
