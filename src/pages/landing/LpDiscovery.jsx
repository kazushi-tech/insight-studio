...
export default function LpDiscovery() {
  return (
    <>
      {/* ━━ 1. Hero ━━ */}
      <LpSection className="relative pt-32 pb-24 px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 bg-primary-fixed/20 border border-primary/15 rounded-full px-5 py-2">
              <span className="material-symbols-outlined text-primary text-base">travel_explore</span>
              <span className="text-sm font-bold tracking-widest text-primary font-label">COMPETITOR DISCOVERY</span>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                to="/"
                className="inline-flex items-center justify-center gap-2 px-10 py-5 bg-primary text-on-primary rounded-2xl font-extrabold text-lg shadow-xl shadow-primary/25 hover:-translate-y-1 transition-all"
              >
                無料で試してみる
          ...
          <div className="relative flex justify-center lg:justify-end">
            ...
            <div className="absolute -top-10 -right-10 w-24 h-24 bg-tertiary-fixed-dim rounded-full blur-3xl opacity-50" />
          </div>
        </div>
      </LpSection>
      ...
      <LpSection className="py-24 bg-white px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="font-headline text-3xl lg:text-5xl font-extrabold text-on-surface tracking-tight mb-6">
              広告運用チームが直面する競合分析の壁
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            {problems.map((p) => (
              <div
                key={p.icon}
                className={`${p.span} ${p.bg || 'bg-surface-container-low'} p-10 rounded-3xl hover:-translate-y-2 hover:shadow-xl transition-all duration-300`}
              >
                <span className="material-symbols-outlined text-primary text-5xl mb-4">{p.icon}</span>
                <h3 className="font-headline text-2xl font-bold text-on-surface mb-4">{p.title}</h3>
                <p className="font-body text-on-surface-variant leading-relaxed">{p.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <LpSection id="demo" stagger className="py-24 bg-surface-container-low px-8 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-bold tracking-widest text-primary mb-4 font-label">HOW IT WORKS</p>
            <h2 className="font-headline text-3xl md:text-5xl font-extrabold text-on-surface">たった3ステップで完了</h2>
          </div>
            ...
            {steps.map((s, i) => (
              <div key={s.num} className="contents">
                <div className="w-full md:w-1/3">
                  <div
                    className={`${s.accent ? 'bg-primary text-on-primary' : 'bg-white'} p-8 rounded-3xl shadow-xl shadow-primary/5 relative hover:-translate-y-2 transition-all duration-300`}
                  >
                    ...
                    <h4 className="font-headline text-xl font-bold mb-2">{s.title}</h4>
                    <p className={`font-body ${s.accent ? 'text-white/80' : 'text-on-surface-variant'} text-sm`}>{s.desc}</p>
                  </div>
                </div>
                {i < steps.length - 1 && (
      ...
      <LpSection id="features" className="py-24 bg-white px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-headline text-3xl font-bold text-primary mb-2">Discovery Module</h2>
            <h3 className="font-headline text-4xl font-extrabold text-on-surface tracking-tight">直感的なインターフェースで、洞察を加速。</h3>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 lg:grid-rows-2 gap-4 h-auto lg:h-[800px]">
            ...
            <div className="lg:col-span-8 lg:row-span-2 bg-surface-container-low rounded-3xl p-8 relative overflow-hidden hover:scale-[1.01] transition-transform duration-500 shadow-sm">
              <div className="flex justify-between items-start mb-8">
                <div>
                  <h4 className="font-headline text-2xl font-bold text-on-surface">競合マーケットマップ</h4>
                  <p className="font-body text-on-surface-variant">競合他社のポジショニングを多角的視点で可視化</p>
                </div>
            ...
            {/* Discoveries */}
            <div className="lg:col-span-4 bg-[#003d2a] text-white rounded-3xl p-8 hover:scale-[1.02] transition-transform duration-500 shadow-lg">
              <h4 className="font-headline text-xl font-bold mb-4">新規発見された競合</h4>
            ...
            <div className="lg:col-span-2 bg-surface-container-high rounded-3xl p-6 hover:scale-[1.02] transition-transform duration-500">
              <h4 className="font-body text-sm font-bold text-on-surface-variant uppercase tracking-widest mb-4">ポジション</h4>
              <div className="text-3xl font-extrabold text-primary font-headline">High Tier</div>
              <p className="font-body text-xs text-on-surface-variant mt-2">同業種124社中 12位</p>
            </div>
            ...
            <div className="lg:col-span-2 bg-tertiary-fixed-dim rounded-3xl p-6 hover:scale-[1.02] transition-transform duration-500">
              ...
              <div className="text-4xl font-extrabold text-on-tertiary-fixed font-headline">08</div>
              <p className="font-body text-xs text-on-tertiary-fixed-variant mt-2 font-medium">即対応が必要な競合の動き</p>
            </div>
          </div>
        </div>
      </LpSection>
      ...
      <LpSection className="py-24 bg-[#003d2a] text-white px-8 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-primary-container opacity-20 blur-[120px]" />
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-sm font-bold tracking-widest text-tertiary-fixed-dim mb-4 font-label">IMPACT</p>
              <h2 className="font-headline text-4xl lg:text-5xl font-extrabold tracking-tight mb-8">導入後の圧倒的な変化</h2>
              <div className="space-y-6">
                <div className="flex items-center gap-6">
                  <div className="text-6xl font-extrabold text-primary-fixed-dim font-headline">-85%</div>
                  <div className="text-xl font-bold">競合調査に要する時間</div>
                </div>
                <div className="flex items-center gap-6">
                  <div className="text-6xl font-extrabold text-tertiary-fixed-dim font-headline">3.2倍</div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-sm">
              <h4 className="font-headline text-2xl font-bold mb-6 flex items-center gap-2 text-primary-fixed-dim">
              ...
              <div className="h-1 w-full bg-white/10 rounded-full overflow-hidden">
                <div className="h-full bg-primary-fixed-dim w-[92%]" />
              </div>
      ...
      <LpSection stagger className="py-24 bg-white px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-bold tracking-widest text-primary mb-4 font-label">TESTIMONIALS</p>
            <h2 className="font-headline text-4xl font-extrabold text-on-surface tracking-tight">多くのリーダーに選ばれています</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {testimonials.map((t) => (
              <div
                key={t.name}
                className="glass-card p-8 rounded-3xl border border-outline-variant/20 shadow-xl shadow-on-surface/5 hover:-translate-y-2 transition-all duration-300"
              >
                ...
                <p className="font-body text-on-surface-variant italic mb-6">{t.text}</p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-surface-variant rounded-full" />
                  <div>
                    <div className="font-headline font-bold text-sm text-on-surface">{t.name}</div>
                    <div className="font-body text-xs text-on-surface-variant">{t.role}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <LpCta
        variant="dark"
        heading="競合の動きを、見逃さない。"
        body="今すぐInsight Studioを始めて、市場の全貌を把握しましょう。"
        primaryLabel="無料で競合分析を始める"
        primaryTo="/"
      />
      ...
      <LpSection className="py-24 bg-surface-container-low px-8">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="font-headline text-4xl font-extrabold text-on-surface tracking-tight">よくある質問</h2>
          </div>
          <div className="space-y-4">
            {faqs.map((faq, i) => (
  ...
  return (
    <div className="bg-white rounded-2xl border border-outline-variant/20 overflow-hidden">
      <button
        ...
        className="w-full p-6 text-left font-headline font-bold text-lg flex justify-between items-center hover:text-primary transition-colors"
        aria-expanded={open}
      >
        {question}
        <span
      ...
      >
        <p className="font-body px-6 pb-6 text-on-surface-variant leading-relaxed">{answer}</p>
      </div>
    </div>
  )
}
