"""Adapter from a verified Clerk platform context to legal/privacy RBAC."""
...
def create_platform_legal_identity_dependency(
    session_dependency: Callable,
    *,
    jwt_verifier: ClerkJWTVerifier | None = None,
) -> Callable:
    def current_legal_identity(
        request: Request,
        ...
        try:
            ...
            return LegalIdentity.from_access_context(context)
